...
(async () => {
  ...
  const appendAboutSection = async () => {
    const aboutHTML = `<section class="bg-white dark:bg-gray-900">
  ...
  const appendBlogSection = async () => {
    const blogHTML = `<section class="bg-white dark:bg-gray-900">
  ...
  const appendContactSection = async () => {
    const contactHTML = `<div class="p-4 mx-auto max-w-xl bg-white font-[sans-serif]">
  ...
  const appendFooterToHTML = async () => {
    const footerHTML = `<footer class="footer bg-base-300 text-base-content p-10">
  <nav>
